...
// This is the maximum size we allow per chunk upload. It should be >=
// the client chunk size (5MB) and leave room for any encoding overhead.
// If you need to support larger chunks, increase this accordingly.
